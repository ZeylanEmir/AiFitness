...
namespace AiFitness.ViewModels
{
    public class _7DaysWorkout5 : INotifyPropertyChanged
    {
        ...
        public _7DaysWorkout5()
        {
            ...
            {
                new Exercise { WorkoutStart = "Разминка", Title = "Прыжки звёздочка", Gif = ImageSource.FromFile("Jumpin_Jack.gif"), Reps = "10-15 Повторений" },
                new Exercise { WorkoutStart = "Начало тренировки", Title = "Выпрыгивания с приседа", Gif = ImageSource.FromFile("Viprigivanya_Spriseda.gif"), Reps = "15 Повторений" },
